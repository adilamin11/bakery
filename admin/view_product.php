                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $select = "SELECT cake_shop_product1.*, cake_shop_category1.category_name FROM cake_shop_product1 JOIN cake_shop_category1 ON cake_shop_product1.product_category = cake_shop_category1.category_id";
