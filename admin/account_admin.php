                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../Image/user.png" alt="" class="user-avatar-md rounded-circle"></a>
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        $select = "SELECT * FROM cake_shop_admin_registrations1 where admin_id = $admin_id";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        <h5 class="form-control form-control-lg" type="text" name="admin_username" required="" autocomplete="off"><?php echo $res['admin_username'];?></h5>
                                    </div>
                                    <div class="form-group">
                                        <h5 class="form-control form-control-lg" type="email" name="admin_email" required="" autocomplete="off"><?php echo $res['admin_email'];?></h5>
                                    </div>
                                    <div class="form-group">
                                        <h5 class="form-control form-control-lg" type="text" required="" name="admin_password"><?php echo $res['admin_password'];?></h5>
                                    </div>
